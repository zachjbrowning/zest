...
export default class LiveReload extends Component {
    ...
    copyJSON() {
        let toCopy = JSON.stringify(this.state.object, null, '  ');
    ...
    render() {
        ...
        return (
            <div className="dev-holder container">
                ...
                <div className="dev-holder container">
                    Please note - this feature is very much stil in development, and only supports a small subset of the full zest features.
                </div>
